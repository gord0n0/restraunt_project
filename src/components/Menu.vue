<template>
                   ...
                   <v-col cols="12" md="4" v-for="item in menuItems":key=item>
                       <v-card>
                           <v-card color="black">
                               ...
                               <v-card-text>
                                   {{ item.price }}
                                   <v-btn color= "orange" variant="tonal" @click="addToOrder(item)">
                                       Order
                                   </v-btn>
   ...
   const menuItems = [
       ...
       },
       {
           name:"juice",
           price: 499,
           description: "best juice in town",
           size: "None",
           offers: "None",
           image: "../public/drink 3.avif"
       },
       {
           name:"kabab",
           price: 250,
           description: "best kababs in town",
           size: "None",
           offers:"None",
           image: "../public/food 3.jpg"
       }
   ]
   var orderItems=[]
